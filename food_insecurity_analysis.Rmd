...
fea_not_high <- filter(fea, !State %in% high_insecurity_states)
...
ggplot() + 
  ...
  ggtitle('Median HH Income (County): Highest Food Insecurity States & US')
```
...
ggplot() + 
  ...
  geom_density(data = fea, aes(MEDHHINC10, color = 'US', fill = 'US'), alpha = 0.1) + 
  ggtitle('Median HH Income (County): Lowest Food Insecurity States & US')
```
...
ggplot() + 
  ...
  geom_boxplot(data = fea_not_high, aes(x = 'rest of US', y = MILK_PRICE10)) + 
...
```{r}
ggplot() + 
  geom_point(data = fea_high, aes(x = State, y = FOOD_TAX11)) + 
  geom_point(data = fea_low, aes(x = State, y = FOOD_TAX11)) + 
  geom_boxplot(data = fea_not_high, aes(x = 'rest of US', y = FOOD_TAX11)) + 
  geom_boxplot(data = fea, aes(x = 'US', y = FOOD_TAX11)) + 
  ggtitle('General food sales tax (State)')
```
...
ggplot() + 
  ...
  geom_boxplot(data = fea_not_high, aes(x = 'rest of US', y = PCT_LACCESS_POP10)) + 
  geom_boxplot(data = fea, aes(x = 'US', y = PCT_LACCESS_POP10)) + 
  ggtitle('Low Access to Store (%) (County)')
```
